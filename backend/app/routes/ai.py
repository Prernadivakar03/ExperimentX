...
#         current_user,
#         db,
#         minimum_role=MemberRole.viewer,
#     )
...
Use bullet points when listing things. You help product managers, developers, and growth teams run better experiments."""
    ...
    try:
        # Reuse the single shared client/model from core.ai instead of
        # instantiating a fresh Groq client on every chat request.
        from app.core.ai import client, MODEL
        response = client.chat.completions.create(
            model=MODEL,
            messages=messages,
            max_tokens=400,
