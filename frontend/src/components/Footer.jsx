...
//         isDark
//           ? "border-white/5 bg-gradient-to-b from-[#0D0E1A] to-[#080912]"
...
//         {/* ── Brand + Social Icons ── */}
//         <div className="flex flex-col md:flex-row items-center justify-between gap-4 pb-6 border-b border-gray-200/60 dark:border-white/5">
//           <motion.div
...
//           {columns.map((col) => (
//             <div key={col.title}>
//               <h4 className={`font-display font-semibold text-sm mb-3 ${isDark ? "text-white/60" : "text-gray-700"}`}>
//                 {col.title}
//               </h4>
...
//         <div className="flex justify-center gap-5 py-4 border-t border-gray-200/60 dark:border-white/5">
...
//         {/* ── Bottom Bar ── */}
//         <div className="pt-4 border-t border-gray-200/60 dark:border-white/5 flex flex-col md:flex-row items-center justify-between gap-3 text-xs">
//           <span className={isDark ? "text-white/20" : "text-gray-400"}>
//             © {new Date().getFullYear()} ExperimentX &middot; Experiment fearlessly.
//           </span>
//           <span className={isDark ? "text-white/15" : "text-gray-400"}>
//             Powered by AI
//           </span>
//         </div>
//       </div>
