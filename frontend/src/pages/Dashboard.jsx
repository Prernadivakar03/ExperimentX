...
const NAV = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M9 20H4v-2a3 3 0 015.356-1.857M9 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
      </svg>
    ),
  },
  {
...
export default function Dashboard() {
  ...
  return (
    <div className={`flex h-screen overflow-hidden ${mainBg}`}>
      ...
      {/* Main */}
      <div className={`flex-1 flex flex-col min-w-0 overflow-hidden relative ${mainBg}`}>
        {/* Network background — sits behind everything in the main area */}
        <NetworkBackground
          nodeCount={45}
          maxDistance={140}
          speed={0.4}
        ...
        {/* Top bar */}
        <header className={`relative z-10 flex items-center gap-4 px-4 md:px-6 h-14 border-b backdrop-blur-md flex-shrink-0 ${topbarBg}`}>
          {/* Mobile menu */}
          <button
