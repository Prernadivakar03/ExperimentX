...
// function FeatureCard({ icon: Icon, title, desc, color, link, isDark, index }) {
//   return (
//     <Reveal delay={index * 0.05}>
//       <div
//         className={`p-6 rounded-2xl border transition-all hover:shadow-xl hover:-translate-y-1 ${
//           isDark
...
//         <p className={`text-sm mt-1 ${isDark ? "text-white/40" : "text-gray-500"}`}>{desc}</p>
//         <a
//           href={link}
//           className="inline-flex items-center gap-1 text-xs font-medium text-brand-violet mt-3 hover:underline"
//         >
//           Learn More →
//         </a>
//       </div>
...
//       <div className="relative z-10 w-12 h-12 rounded-full flex items-center justify-center border-2 border-brand-violet bg-brand-violet/5 dark:bg-brand-violet/10">
...
//   return (
//     <Reveal>
//       <div className={`p-4 rounded-xl border ${isDark ? "bg-[#0D0E1A] border-white/[0.07]" : "bg-white border-gray-200 shadow-sm"}`}>
...
//   // Background gradient with floating decorations
//   const bgStyle = isDark
//     ? "bg-[#05060d] bg-gradient-to-b from-[#0a0d1c] to-[#05060d]"
//     : "bg-[#FAFBFC] bg-[radial-gradient(ellipse_at_top,_rgba(108,92,231,0.06),_transparent_50%)]";

//   return (
//     <div className={`relative min-h-screen transition-colors ${bgStyle}`}>
//       {/* Floating decorations */}
//       <div className="absolute top-40 left-10 w-96 h-96 rounded-full blur-3xl bg-brand-violet/5 dark:bg-brand-violet/10 pointer-events-none" />
//       <div className="absolute bottom-20 right-10 w-80 h-80 rounded-full blur-3xl bg-brand-blue/5 dark:bg-brand-blue/10 pointer-events-none" />
...
//             <button className="px-6 py-3 rounded-xl text-sm font-medium text-white bg-gradient-to-r from-brand-violet to-brand-blue shadow-lg hover:shadow-xl transition-shadow">
//               Start Free Trial
//             </button>
//             <button className={`px-6 py-3 rounded-xl text-sm font-medium flex items-center gap-2 border ${
...
//               <span className={isDark ? "text-white/60" : "text-gray-600"}>4.9/5 (500+ reviews)</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <TrendingUp className="text-emerald-500" size={16} />
//               <span className={isDark ? "text-white/60" : "text-gray-600"}>10,000+ experiments run</span>
//             </div>
//           </div>
//         </Reveal>
//       </section>

//       {/* ── Trusted By – Tech Stack Cards (now with Lucide icons) ── */}
//       <section className="py-8 border-y border-gray-200/30 dark:border-white/[0.06]">
//         <Reveal>
...
//       {/* ── How It Works ── */}
//       <section className={`py-20 px-4 ${isDark ? "bg-[#0D0E1A]" : "bg-white"} border-y ${isDark ? "border-white/[0.06]" : "border-gray-100"}`}>
...
//       {/* ── Analytics Showcase (Real Dashboard) ── */}
//       <section className={`py-20 px-4 ${isDark ? "bg-[#0D0E1A]" : "bg-white"} border-y ${isDark ? "border-white/[0.06]" : "border-gray-100"}`}>
//         <div className="max-w-7xl mx-auto">
//           <Reveal>
//             <div className="text-center mb-12">
...
//             {/* Fake dashboard – now with Lucide icons */}
//             <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
//               <div className={`p-4 rounded-xl border ${isDark ? "border-white/[0.06]" : "border-gray-200"}`}>
//                 <div className="flex items-center gap-2 text-xs text-gray-400">
//                   <BarChart3 size={14} /> Visitors
//                 </div>
//                 <div className="text-2xl font-bold mt-1">12,438</div>
//                 <div className="text-xs text-emerald-500">+8.2%</div>
//               </div>
//               <div className={`p-4 rounded-xl border ${isDark ? "border-white/[0.06]" : "border-gray-200"}`}>
//                 <div className="flex items-center gap-2 text-xs text-gray-400">
...
//                 <div className="text-xs text-emerald-500">+0.6%</div>
//               </div>
//               <div className={`p-4 rounded-xl border ${isDark ? "border-white/[0.06]" : "border-gray-200"}`}>
//                 <div className="flex items-center gap-2 text-xs text-gray-400">
//                   <Target size={14} /> Confidence
//                 </div>
//                 <div className="text-2xl font-bold mt-1">98%</div>
//                 <div className="text-xs text-emerald-500">Very high</div>
//               </div>
//               <div className={`p-4 rounded-xl border ${isDark ? "border-white/[0.06]" : "border-gray-200"}`}>
//                 <div className="flex items-center gap-2 text-xs text-gray-400">
//                   <DollarSign size={14} /> Revenue Lift
//                 </div>
//                 <div className="text-2xl font-bold mt-1 text-emerald-500">+15.3%</div>
//                 <div className="text-xs text-emerald-500">Variant B winning</div>
//               </div>
//             </div>
...
//             </h2>
//             <p className={`text-sm mt-2 mb-12 ${isDark ? "text-white/40" : "text-gray-500"}`}>
...
//         <Reveal>
//           <h2 className={`text-3xl font-display font-bold text-center mb-12 ${isDark ? "text-white" : "text-gray-900"}`}>
...
//                 Start Free Trial
//               </button>
//               <button className={`px-6 py-3 rounded-xl text-sm font-medium border ${
//                 isDark ? "border-white/10 text-white/70 hover:bg-white/5" : "border-gray-300 text-gray-700 hover:bg-gray-50"
//               } transition-colors`}>
//                 Book Demo
//               </button>
...
// // ── Updated FeatureCard – no colored square behind icon ──
